 ...
 * @author Admin
 */
public class FrameThemBenhNhan extends javax.swing.JFrame implements ActionListener{

    /**
     * Creates new form FrameThemBenhNhan
     */
    private ArrayList<Patient> listPatient = new  ClinicDAO().getAllPatient();
    private ArrayList<Relatives> listRelative = new ClinicDAO().getAllRelatives();
    private int  idmaxPatient = listPatient.get(listPatient.size()-1).getID();
   // private int idmaxRelative = listRelative.get(listRelative.size()-1).getID();
    private boolean ButtonAddisClicked  = false;
    public FrameThemBenhNhan() {
        initComponents();
        setLocationRelativeTo(null);
        jButtonLamMoi.addActionListener(this);
        jButtonThemBN.addActionListener(this);
        jButtonQuayLai.addActionListener(this);
        jButtonNhapTTChiTiet.addActionListener(this);
        ...
        labelErrorSex.setText("");
        labelErrorLoaiBN.setText("");
        jLabelID.setText(String.valueOf(idmaxPatient+1));
        jLabelIDPatient.setText(String.valueOf(idmaxPatient+1));
    ...
    private void initComponents() {
        ...
        jButtonNhapTTChiTiet = new javax.swing.JButton();
        JLabelID = new javax.swing.JLabel();
        jLabelID = new javax.swing.JLabel();
        jLabelIDNguoiThan = new javax.swing.JLabel();
        jLabelIDPatient = new javax.swing.JLabel();
        ...
        labelErrorSex = new javax.swing.JLabel();
        labelErrorLoaiBN = new javax.swing.JLabel();
        ...
        jLabel9.setBounds(101, 59, 142, 25);
        ...
        jLabelSDTNguoiThan.setBounds(520, 260, 96, 17);
        ...
        jLabel14.setBounds(510, 400, 160, 17);
        ...
        jButtonQuayLai.setBounds(210, 710, 125, 40);
        ...
        buttonGroup3.add(jRadioButtonMeMangThai);
        ...
        buttonGroup3.add(jRadioButtonTre);
        ...
        jButtonNhapTTChiTiet.setBackground(new java.awt.Color(0, 153, 102));
        jButtonNhapTTChiTiet.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jButtonNhapTTChiTiet.setForeground(new java.awt.Color(255, 255, 255));
        jButtonNhapTTChiTiet.setText("NHẬP THÔNG TIN CHI TIẾT");
        getContentPane().add(jButtonNhapTTChiTiet);
        jButtonNhapTTChiTiet.setBounds(540, 710, 270, 40);

        JLabelID.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        JLabelID.setText("ID");
        getContentPane().add(JLabelID);
        JLabelID.setBounds(44, 128, 60, 17);

        jLabelID.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabelID.setText("ID BỆNH NHÂN TỰ ĐỘNG CẬP NHẬT");
        getContentPane().add(jLabelID);
        jLabelID.setBounds(170, 120, 253, 26);
        ...
        jLabelIDNguoiThan.setBounds(540, 130, 40, 17);

        jLabelIDPatient.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabelIDPatient.setText("TỰ CẬP NHẬT");
        getContentPane().add(jLabelIDPatient);
        jLabelIDPatient.setBounds(740, 130, 100, 17);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setText("NGƯỜI THÂN");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(680, 60, 200, 22);

        jButtonThemBN.setBackground(new java.awt.Color(0, 153, 102));
        jButtonThemBN.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jButtonThemBN.setForeground(new java.awt.Color(255, 255, 255));
        jButtonThemBN.setText("THÊM");
        getContentPane().add(jButtonThemBN);
        jButtonThemBN.setBounds(850, 710, 100, 40);
        ...
        jButtonLamMoi.setBounds(380, 710, 120, 40);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel2.setText("     THÊM BỆNH NHÂN");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(320, 10, 300, 27);
        ...
        labelErrorSex.setForeground(new java.awt.Color(255, 0, 0));
        labelErrorSex.setText("jLabel5");
        getContentPane().add(labelErrorSex);
        labelErrorSex.setBounds(170, 350, 190, 14);

        labelErrorLoaiBN.setForeground(new java.awt.Color(255, 0, 0));
        labelErrorLoaiBN.setText("jLabel3");
        getContentPane().add(labelErrorLoaiBN);
        labelErrorLoaiBN.setBounds(170, 580, 200, 14);
...
//    }
    ...
    private javax.swing.JButton jButtonNhapTTChiTiet;
    ...
    private javax.swing.JLabel jLabelIDPatient;
    ...
    private javax.swing.JLabel labelErrorLoaiBN;
    ...
    private javax.swing.JLabel labelErrorSex;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(jButtonThemBN)) {
            ...
            btnQuayLaiClick();
        } else if (e.getSource().equals(jButtonLamMoi)) {
            btnLamMoiClick();
        } else {
            btnNhapThongTinChiTietClick();
        }
    ...
    public void btnAddClick() {
        ...
        boolean test = true; // thiết lập biến kiểm tra việc thêm bệnh nhân
        try {
            ++idmaxPatient; // cập nhật id Bệnh nhân 
            p.setID(idmaxPatient);
            ...
            if (!jRadioButtonNam.isSelected()&&!jRadioButtonNu.isSelected()) {
                labelErrorSex.setText("Chưa chọn giới tính");
                test = false;
            }
            ...
            if (!jRadioButtonMeMangThai.isSelected()&&!jRadioButtonTre.isSelected()) {
                labelErrorLoaiBN.setText("Chưa chọn loại bệnh nhân");
                test = false;
            }
            if (jRadioButtonMeMangThai.isSelected()) {
                p.setKindOfPatient("Mẹ mang thai");
            } else {
                p.setKindOfPatient("Trẻ em");
            }
            if (jRadioButtonNam.isSelected() && jRadioButtonMeMangThai.isSelected()) {
                JOptionPane.showMessageDialog(rootPane, "Sai giới tính mẹ mang thai", "Lỗi: ", JOptionPane.ERROR_MESSAGE);
                test = false;
            }
            
            r.setID(idmaxPatient);
            r.setIDPatient(idmaxPatient);
            ...
            else if (jTextFieldQuanHe.getText().equals("")) {
                labelErrorQuanHe.setText("Chưa nhập quan hệ với bệnh nhân");
                test = false;
            }
            else {
            ...
            if (test) {
                if (new ClinicDAO().addNew(p) && new ClinicDAO().addNew(r)) {
    ...
    public void btnNhapThongTinChiTietClick() {
        if (ButtonAddisClicked) { // nếu đã bấm nút thêm bệnh nhân
           
            if (jRadioButtonMeMangThai.isSelected()) // nếu loại bệnh nhân là "Mẹ mang thai"
            {
                new FrameThemTTChiTietCuaMe(idmaxPatient).setVisible(true); // chuyển qua FrameThemTTChiTietCuaMe
                this.dispose();
            } else if (jRadioButtonTre.isSelected()) { // nếu loại bệnh nhân là "Trẻ em"
                new FrameThemTTChiTietCuaTre(idmaxPatient).setVisible(true); // chuyển qua FrameThemTTChiTietCuaBe
                this.dispose();
            } else { // nếu chưa chọn loại bênh nhân
                JOptionPane.showMessageDialog(rootPane, "Bạn chưa chọn loại bệnh nhân", "Lỗi: ", JOptionPane.ERROR_MESSAGE); // báo lỗi
            }
        } else { // nếu chưa thêm bệnh nhân đã chọn nhập tt chi tiết
            JOptionPane.showMessageDialog(rootPane, "Vui lòng ấn nút THÊM trước khi nhập thông tin chi tiết", "Lỗi: ", JOptionPane.ERROR_MESSAGE);
        }
    }
